...
class AsrTests(unittest.TestCase):
    ...
    def test_canonicalizes_recurring_linux_terms_without_guessing_bare_iperf(self) -> None:
        text = (
            "I used su2, sud, SU-DU, SU due, S UDO, this UDO, and this you do with the system d service, SystemCTL, "
        ...
        self.assertEqual(
            ...
            (
                "I used sudo, sudo, sudo, sudo, sudo, sudo, and sudo with the systemd service, systemctl, "
